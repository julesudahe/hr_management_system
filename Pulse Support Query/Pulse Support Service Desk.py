# Pulse Support Service Desk (CMS) Extraction of Data to Sharepoint in csv file
...
jira_username = 'p.homer@bboxx.co.uk'
...
authcookie = Office365('https://bboxxeng.sharepoint.com/', username='support.reports@bboxx.co.uk', password='hwFNzdyFLc2$').GetCookies()
site = Site('https://bboxxeng.sharepoint.com/teams/Engineering', version=Version.v2016, authcookie=authcookie)
folder = site.Folder('Development/Service Desk Reporting/TEST')
...
if __name__ == "__main__":
    ...
    for desk_id in service_desk_list:
        ...
        search_string = 'project = ' + desk_id + ' and created > \'2021\''
        ...
        for page in range(page_qty):
            ...
            for issue in tix:
                ...
                if desk_id == "CMS":
                    ...
                    #Customer Issue
                    try:
                        customer_issue = issue.raw['fields']['customfield_11543']['value']
                    except:
                        customer_issue = ""
                    ...
                    #Stock/Warehouse Issue
                    try:
                        stock_warehouse_issue = issue.raw['fields']['customfield_11547']['value']
                    except:
                        stock_warehouse_issue = ""

                    #Customer Satisfaction
                    try:
                        customer_satisfaction = issue.raw['fields']['customfield_10802']['rating']
                    except:
                    ...
                    issue_list_cms = [root_cause, reason_for_breach, reason_for_breach_comment, resolution_brackets,
                                    ...
                                    weekly_status, last_public_comment_date, erp_module, sales_agent_issue,crm_application, customer_issue, 
                                    payg_issue, payment_issue, stock_warehouse_issue,customer_satisfaction, labels_list[0],labels_list[1]]
        ...
        fname = "jira_dump_{}.csv".format(desk_id)
        ...
        #with open(fname, 'rb') as dump_file:
            #url = base_path + "/teams/" + site_name + "/_api/web/GetFolderByServerRelativeUrl('" + doc_library + "')/Files/add(url='" + fname + "',overwrite=true)"
           # response = session.post(url=url,data=dump_file)
        with open(fname, mode='rb') as file:
            fileContent = file.read()
            folder.upload_file(fileContent, fname)
